...
from ULTRON import pbot as app 
from ULTRON import arq
from ULTRON.services.keyboard import Ikb
from ULTRON.utils.pluginhelper import convert_seconds_to_minutes as time_convert, fetch
from ULTRON.services.tasks import _get_tasks_text, all_tasks, rm_task
from ULTRON.services.types import InlineQueryResultCachedDocument
from ULTRON.modules.info import get_chat_info, get_user_info
from ULTRON.modules.music import download_youtube_audio
from ULTRON.utils.functions import test_speedtest
from ULTRON.utils.pastebin import paste
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [UBOT](t.me/ULTRON_OWNER)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
