...
import telegram
from ULTRON import TIGERS, WOLVES, dispatcher
from ULTRON.modules.disable import DisableAbleCommandHandler
from ULTRON.modules.helper_funcs.chat_status import (
    bot_admin,
    can_restrict,
    is_user_admin,
    user_admin,
...
from ULTRON.modules.helper_funcs.extraction import (
    extract_text,
    extract_user,
...
from ULTRON.modules.helper_funcs.string_handling import split_quotes
from ULTRON.modules.log_channel import loggable
from ULTRON.modules.sql import warns_sql as sql
