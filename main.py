...
import sys
import traceback
import ULTRON.modules.sql.users_sql as sql
...
from ULTRON.modules import ALL_MODULES
from ULTRON.modules.helper_funcs.chat_status import is_user_admin
from ULTRON.modules.helper_funcs.misc import paginate_modules
...
PM_START_TEXT = """
*Hello {} !*
😈 HI'm ULTRON, An anime - Themed advanced telegram Group management with lots of features.
───────────────────────
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
───────────────────────
...
buttons = [
    [
        InlineKeyboardButton(
            text="ᴀᴅᴅ ᴍᴇ ᴇʟꜱᴇ ᴜ ɢᴀʏ🔥", url="t.me/ULTRON_fighters_bot?startgroup=true"),
    ],
     [
        InlineKeyboardButton(text="ʙᴀꜱɪᴄ ɢᴜɪᴅᴇ ", callback_data="emiko_"),
     ], 
     [  
        InlineKeyboardButton(text="ꜱᴜᴘᴘᴏʀᴛ ⚒️", url="https://t.me/ULTRON_userbot"),
        InlineKeyboardButton(text="ᴜᴘᴅᴀᴛᴇꜱ 📢", url="https://t.me/ULTRON_techy"),
    ], 
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("ULTRON.modules." + module_name)
...
def emiko_about_callback(update, context):
    ...
    if query.data == "emiko_":
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    InlineKeyboardButton(text="Support ⚒️", callback_data="ULTRON_userbot"),
        ...
        query.message.edit_text(
            text="*✨ support chats*"
            "\nJoin My Support Group/Channel for see or report a problem on ULTRON.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Support", url="t.me/ULTRON_Userbot"),
                    InlineKeyboardButton(text="Updates", url="https://t.me/ULTRON_Techy"),
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="emiko_"),
